...
class i2cBitBangingBus
    ...
    public:
        ...
        // 
        int32_t i2c_smbus_write_i2c_block_data_no_command (uint8_t i2c_address, uint32_t length, const uint8_t * values);
        ...
        //
         int32_t i2c_smbus_read_i2c_block_data_no_command (uint8_t i2c_address,uint8_t length, uint8_t* values);
